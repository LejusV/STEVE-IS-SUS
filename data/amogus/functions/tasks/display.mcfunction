...
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=11}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Communications"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=12}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Lower engine"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=13}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Upper engine"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=14}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Weapons"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=15}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Shields"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=16}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Navigation"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=17}] run tellraw @s {"text":" \u0020 \u0020Divert Power to O2"}
execute if entity @s[tag=todo_s_divertpow,scores={divertpow=..8,divertpowerto=18}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Security"}
...
execute if entity @s[scores={divertpow=12,divertpowerto=12}] unless entity @s[tag=todo_l_fuel,tag=task_fuel,scores={fuel_stage=2}] unless entity @s[tag=todo_l_engine,scores={engine_stage=2}] run tellraw @s {"text":" LOWER ENGINE :","bold":true}
...
execute if entity @s[scores={divertpow=12,divertpowerto=12}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Lower Engine"}
...
execute if entity @s[tag=!todo_l_samples,tag=!todo_l_scan,tag=task_samples] run tellraw @s {"text":" MEDBAY :","bold":true}
...
execute if entity @s[tag=todo_c_wires,scores={wires_loc=6}] run tellraw @s {"text":" \u0020 \u0020Fix Wiring"}
execute if entity @s[scores={divertpow=18,divertpowerto=18}] unless entity @s[tag=todo_c_wires,scores={wires_loc=6}] run tellraw @s {"text":" \u0020 \u0020Divert Power to Security"}
...
execute if entity @s[tag=todo_s_asteroids,tag=!task_asteroids] run tellraw @s ["",{"text":" \u0020 \u0020Clear Asteroids \u0020"},{"score":{"name":"@s","objective":"asteroids"}},{"text":"/20"}]
execute if entity @s[tag=todo_s_asteroids,tag=task_asteroids] run tellraw @s ["",{"text":" \u0020 \u0020Clear Asteroids \u0020","color":"yellow"},{"score":{"name":"@s","objective":"asteroids"},"color":"yellow"},{"text":"/20","color":"yellow"}]

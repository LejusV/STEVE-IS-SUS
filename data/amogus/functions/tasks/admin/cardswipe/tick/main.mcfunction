...
execute as @s at @s run function amogus:tasks/admin/cardswipe/tick/particles/card_gray
execute as @s at @s run function amogus:tasks/admin/cardswipe/tick/particles/card_green
execute as @s at @s run function amogus:tasks/admin/cardswipe/tick/particles/card_white

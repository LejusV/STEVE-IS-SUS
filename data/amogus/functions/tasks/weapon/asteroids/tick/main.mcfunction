...
execute as @e[tag=meteorite,type=armor_stand] at @s rotated 135 0 run tp @s ^ ^ ^0.03
execute as @e[tag=meteorite,type=armor_stand] at @s unless entity @a[tag=task_asteroids,distance=..14] run kill @s
